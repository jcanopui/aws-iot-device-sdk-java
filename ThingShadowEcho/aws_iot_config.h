...
//===============================================================
#define AWS_IOT_MQTT_HOST "a37hc7nazelgx0.iot.us-east-1.amazonaws.com"   // your endpoint
#define AWS_IOT_MQTT_PORT 443                 // your port
#define AWS_IOT_CLIENT_ID "ArduinoYun"            // your client ID
#define AWS_IOT_MY_THING_NAME_LED "ArduinoYunLed"            // your thing name
#define AWS_IOT_MY_THING_NAME_SENSOR "ArduinoYunSensor"            // your thing name
